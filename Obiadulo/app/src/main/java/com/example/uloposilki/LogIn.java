                                ...
                                if (putData.startPut()) {
                                    if (putData.onComplete()) {
                                        ...
                                        if (res.equals("LS")){
                                            ...
                                            finish();
                                        } else if (result.equals("Name or surname or class or password are wrong")) {
                                            Toast.makeText(getApplicationContext(), "Błędne dane",Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(getApplicationContext(), "Błąd zapytania",Toast.LENGTH_SHORT).show();

                                        }
                                    }
                                }
                            }catch (StringIndexOutOfBoundsException e){
                                Toast.makeText(getApplicationContext(), "Sprawdź poprawność danych",Toast.LENGTH_SHORT).show();
                            }
